...
![IUTF SymLogo](../src/imgs/IUTF-LogoSymbolic.png)
...
2. float :: Число с плавающей точкой, например 148.98 **!! Примечание !!** тип float использует в исходниках использует тип double из языка Си.
